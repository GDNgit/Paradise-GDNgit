...
#define SMOOTH_GROUP_XENOMORPH_RESIN S_OBJ(60)			///obj/structure/xenomorph/resin
#define SMOOTH_GROUP_XENOMORPH_WALLS S_OBJ(61)			///obj/structure//resin/wall, /obj/structure/xenomorph/resin/membrane
#define SMOOTH_GROUP_XENOMORPH_WEEDS S_OBJ(62)			///obj/structure/xenomorph/weeds
