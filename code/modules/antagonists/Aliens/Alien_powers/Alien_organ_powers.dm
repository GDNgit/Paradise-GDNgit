//Where all the alien spells/powers from alien organs are kept
...
//Neurotoxin spit
/obj/effect/proc_holder/spell/alien/neurotoxin_spit
...
/obj/effect/proc_holder/spell/alien/neurotoxin_spit/create_new_targeting()
	var/datum/spell_targeting/clicked_atom/C = new()
	C.range = 20
	return C

/obj/effect/proc_holder/spell/alien/neurotoxin_spit/update_icon_state()
	if(!action)
		return
	action.button_icon_state = "neurotoxin_spit[active]"
	action.UpdateButtonIcon()

/obj/effect/proc_holder/spell/alien/neurotoxin_spit/cast(list/targets, mob/living/user = usr)
	...
	var/obj/item/projectile/magic/alien/neurotoxin_spit/NS = new neurotoxin_spit_type(user.loc)
