/datum/xenomorph_cast
	/// we need this for blackbox logging or somethin.
	var/name = "you shouldn't be seeing this"
	/// A list of xenomorph powers the xenomorph gains based on evolution (Yes, not all of them are tied to organs...)
	var/list/xenomorph_powers
//TODO
/datum/xenomorph_cast/proc/add_subclass_ability(datum/antagonist/vampire/vamp)
